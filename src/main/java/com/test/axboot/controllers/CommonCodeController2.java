...
import com.test.axboot.domain.code.CommonCodeServiceV2;
...
public class CommonCodeController2 extends BaseController {

    @Inject
    private CommonCodeServiceV2 basicCodeService;
