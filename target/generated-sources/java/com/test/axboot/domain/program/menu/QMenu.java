...
public class QMenu extends EntityPathBase<Menu> {
    ...
    private static final long serialVersionUID = -356228944L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QMenu menu = new QMenu("menu");

    public final com.test.axboot.domain.QBaseJpaModel _super = new com.test.axboot.domain.QBaseJpaModel(this);
    ...
    public final com.test.axboot.domain.program.QProgram program;
    ...
    public QMenu(Class<? extends Menu> type, PathMetadata metadata, PathInits inits) {
        ...
        this.program = inits.isInitialized("program") ? new com.test.axboot.domain.program.QProgram(forProperty("program")) : null;
    }
