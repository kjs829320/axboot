package com.test.axboot.domain.init;

import com.test.axboot.domain.code.CommonCode;
import com.test.axboot.domain.code.CommonCodeService;
import com.test.axboot.domain.program.Program;
import com.test.axboot.domain.program.ProgramService;
import com.test.axboot.domain.program.menu.Menu;
import com.test.axboot.domain.program.menu.MenuService;
import com.test.axboot.domain.user.User;
import com.test.axboot.domain.user.UserService;
import com.test.axboot.domain.user.auth.UserAuth;
import com.test.axboot.domain.user.auth.UserAuthService;
import com.test.axboot.domain.user.auth.menu.AuthGroupMenu;
import com.test.axboot.domain.user.auth.menu.AuthGroupMenuService;
import com.test.axboot.domain.user.role.UserRole;
import com.test.axboot.domain.user.role.UserRoleService;
